...
public class Detalle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            ...
            detailLang.setText(bundle.getString("Lenguaje"));
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Inventario Android");
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Detalle.this, Subir.class)
                        ...
                        .putExtra("Lenguaje", detailLang.getText().toString())
